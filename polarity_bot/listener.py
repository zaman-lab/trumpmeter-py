...
class StdOutListener(StreamListener):
    ...
    def __init__(self, model):
        """
        model: keras model with weights loaded and custom #classify function defined, ready to make predictions
        """
        self.wait = 0
    ...
    def compile_reply(self, status):
        ...
        if word_count <= 2:
            ...
            result = self.model.classify(tweet_text) # pass in pre-loaded model to prevent re-loading
            print(result)
